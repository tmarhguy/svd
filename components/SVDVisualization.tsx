  ...
  const steps = [
    {
      ...
      formula: "A ∈ ℝ<sup>m×n</sup>",
      icon: Square,
      color: "neon"
    },
    {
      title: "SVD Decomposition",
      description: "We decompose A into three matrices: U (left singular vectors), Σ (singular values), and V<sup>T</sup> (right singular vectors).",
      formula: "A = UΣV<sup>T</sup>",
      icon: Layers,
      color: "plasma"
    },
    {
      ...
      formula: "A<sub>k</sub> = U<sub>k</sub> Σ<sub>k</sub> V<sub>k</sub><sup>T</sup>",
      icon: Zap,
      color: "matrix"
    },
    {
